...
with open ('HeightWeightDATA.csv',newline='')as f:
    reader = csv.reader(f)
...
for height, occurance in data.items():
    if 75<float(height)<85:
        data_range["75-85"]+=occurance
    elif 85<float(height)<95:
        data_range["85-95"]+=occurance
    elif 95<float(height)<105:
        data_range["95-105"]+=occurance
    elif 105<float(height)<115:
        data_range["105-115"]+=occurance
    elif 115<float(height)<125:
        data_range["115-125"]+=occurance
    elif 125<float(height)<135:
        data_range["125-135"]+=occurance
    elif 135<float(height)<145:
        data_range["135-145"]+=occurance
    elif 145<float(height)<155:
        data_range["145-155"]+=occurance
    elif 155<float(height)<165:
        data_range["155-165"]+=occurance
    elif 165<float(height)<175:
        data_range["165-175"]+=occurance
